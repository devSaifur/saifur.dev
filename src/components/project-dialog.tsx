...
export const ProjectDialog = ({
  ...
  return (
    ...
    >
      ...
      <DialogContainer>
        <DialogContent
          className="relative mx-4 max-w-2xl border border-teal-600 bg-stone-900/90"
          style={{
            borderRadius: '12px',
          }}
        >
